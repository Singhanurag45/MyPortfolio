...
const SkillCard = ({ index, name, icon }) => (
  <motion.div
    ...
    className="w-28 h-28 flex flex-col items-center justify-center gap-2 p-4 bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl border border-slate-700 hover:border-blue-500/50 shadow-lg hover:shadow-xl hover:shadow-blue-500/20 transition-all duration-300"
  >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
          {skills.map((category, categoryIndex) => (
            <motion.div
              ...
              className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50 hover:border-blue-500/30 transition-all duration-300"
            >
              {/* Category Header */}
              <div className="mb-6">
